...
ActiveRecord::Schema[7.1].define(version: 2024_02_21_011414) do
  ...
  create_table "aladin_book_entries", force: :cascade do |t|
    ...
    t.index ["mastodon_status_id"], name: "index_aladin_book_entries_on_mastodon_status_id"
  end
